...
export function MentoriaLandingPageEstrategista() {
    ...
    <div className="mentoria-landing-page">
      {isModalOpen ? (
        <div className="mentoria-landing-modal-shell" role="dialog" aria-modal="true" aria-label="Aplicação Mentoria">
          ...
          <div className="mentoria-landing-modal-card">
            ...
            {!isSubmitted ? (
              <>
                <MentoriaEyebrow>FORMACAO ESTRATEGISTA DE HEDGE</MentoriaEyebrow>
                ...
                <form className="mentoria-landing-form" onSubmit={handleSubmit}>
                  ...
                  <label>
                    <span>Qual o objetivo com a formação?</span>
                    <select
                  ...
                  <label>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="4"
                      placeholder="Conte um pouco sobre seu momento e o que busca na formação."
                    />
                  </label>
      ...
      <MentoriaSection id="formacao" className="mentoria-landing-surface-gradient mentoria-landing-formacao">
        <div className="mentoria-landing-section-head mentoria-landing-formacao-head">
          ...
          <h2 className="mentoria-landing-section-title mentoria-reveal mentoria-reveal-delay-1">
            Estrategista de Hedge
          </h2>
          <p className="mentoria-landing-formacao-subtitle mentoria-reveal mentoria-reveal-delay-2">
            Seja o Profissional <span>+ Procurado do Agro</span>
          </p>
          <p className="mentoria-landing-formacao-tagline mentoria-reveal mentoria-reveal-delay-2">
            Da base sólida ao jogo de verdade — em uma única jornada.
          </p>
        </div>

        <div className="mentoria-landing-formacao-grid mentoria-reveal mentoria-reveal-delay-3">
          <div className="mentoria-landing-formacao-content">
            <h3 className="mentoria-landing-formacao-h3">Conteúdos e o que você terá acesso</h3>
            <ul className="mentoria-landing-formacao-list">
              {FORMACAO_CONTEUDOS.map((item) => (
                <li key={item}>
                  <span className="mentoria-landing-formacao-check" aria-hidden="true">✓</span>
                  <span>{item}</span>
                </li>
              ))}
            </ul>

            <h3 className="mentoria-landing-formacao-h3">Tudo isso ainda inclui</h3>
            <ul className="mentoria-landing-formacao-list mentoria-landing-formacao-list-bonus">
              {FORMACAO_BENEFICIOS.map((item) => (
                <li key={item}>
                  <span className="mentoria-landing-formacao-check" aria-hidden="true">★</span>
                  <span>{item}</span>
                </li>
          ...
          <aside className="mentoria-landing-pricing-card">
            <span className="mentoria-landing-pricing-flag">Valor promocional de lançamento</span>
            <div className="mentoria-landing-pricing-old">
              de <s>R$ 10.000</s> por
            </div>
            <div className="mentoria-landing-pricing-main">
              <span className="mentoria-landing-pricing-installments">12x de</span>
              <span className="mentoria-landing-pricing-price">307</span>
            </div>
            <div className="mentoria-landing-pricing-cash">
              ou <strong>R$ 2.970</strong> à vista
            </div>
            <ul className="mentoria-landing-pricing-perks">
              <li>Plataforma com aulas gravadas — do básico ao avançado</li>
              <li>1 encontro ao vivo com o mentor a cada 15 dias</li>
              <li>Comunidade exclusiva no WhatsApp</li>
              <li>Sistema Hedge Position — o melhor do Brasil</li>
              <li>6 meses de acesso completo</li>
            </ul>
            <button
              type="button"
              className="mentoria-landing-primary-btn mentoria-landing-pricing-cta"
      ...
      <footer className="mentoria-landing-footer">
        ...
        <p>© {currentYear} - Landing Page Estrategista de Hedge.</p>
      </footer>
    </div>
  );
}
