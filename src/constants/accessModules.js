export const moduleOptions = [
  ...
  { value: "dashboard_cashflow", label: "Dashboard: Fluxo de Caixa - Hedge" },
  ...
  { value: "dashboard_mtm", label: "Dashboard: MTM Derivativos" },
  { value: "dashboard_dre_balanco", label: "Dashboard: DRE e Balanço" },
  ...
  { value: "ops_cash_payments", label: "Operações: Empréstimos" },
  { value: "ops_other_cash_outflows", label: "Operações: Outras saídas Caixa" },
  { value: "ops_other_entries", label: "Operações: Outras Entradas Caixa" },
  ...
  { value: "sys_receipt_clients", label: "Admin: Clientes" },
  { value: "sys_receipt_entries", label: "Admin: Entradas" },
