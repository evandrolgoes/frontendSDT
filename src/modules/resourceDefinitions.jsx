...
const baseResourceDefinitions = {
  ...
  cashPayments: {
    ...
    title: "Pgtos Caixa",
    description: "Pagamentos de caixa com grupo, subgrupo, valor da parcela, volume total da operacao, moeda e contraparte.",
    ...
    columns: [
      ...
      { key: "volume_total_operacao", label: "Volume total da operacao", type: "number" },
      { key: "moeda", label: "Moeda" },
      { key: "data_pagamento", label: "Data pagamento", type: "date" },
      { key: "contraparte", label: "Contraparte", type: "relation", ...commonRelationFields.contraparte },
    ],
    fields: [
      ...
      { name: "volume_total_operacao", label: "Volume total da operacao", type: "number", optional: true },
      { name: "moeda", label: "Moeda", ...catalogSelectFields.moeda },
      { name: "data_pagamento", label: "Data pagamento", type: "date" },
      { name: "descricao", label: "Descricao", type: "textarea" },
      { name: "contraparte", label: "Contraparte", ...commonRelationFields.contraparte, optional: true },
