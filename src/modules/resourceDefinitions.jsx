...
const baseResourceDefinitions = {
  ...
  receiptEntries: {
    ...
    description: "Lancamentos de recebimentos com cliente, datas, NF, produto, status e valor.",
    ...
    fields: [
      ...
      { name: "nf", label: "NF", optional: true },
      { name: "observacoes", label: "Observacoes", type: "textarea", optional: true },
      { name: "produto", label: "Produto", optional: true },
      { name: "status", label: "Status", optional: true },
      { name: "valor", label: "Valor (R$)", type: "number", optional: true },
    ],
  },
  counterparties: {
  ...
  accountsPayable: {
    ...
    fields: [
      ...
      { name: "forma_pagamento", label: "Forma Pagamento", optional: true },
      { name: "obs", label: "Obs", type: "textarea", optional: true },
      { name: "referencia", label: "Referencia", optional: true },
      { name: "status", label: "Status", optional: true },
