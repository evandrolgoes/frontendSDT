...
const baseResourceDefinitions = {
  tenants: {
    ...
    fields: [
      ...
      { name: "can_register_subgroups", label: "Fará cadastro de subgrupos?", type: "select", options: yesNoOptions, optional: true },
      {
        ...
        type: "select-multi",
        resource: "tenants/available-modules",
        valueKey: "value",
        labelKey: "label",
        optional: true,
  ...
  users: {
    ...
    fields: [
      ...
      { name: "accessible_groups", label: "Grupos", type: "multirelation", resource: "groups", labelKey: "grupo", checkboxList: true, optional: true, section: "Acesso" },
      { name: "accessible_subgroups", label: "Subgrupos", type: "multirelation", resource: "subgroups", labelKey: "subgrupo", checkboxList: true, optional: true, section: "Acesso" },
      { name: "access_status", label: "Status", type: "select", options: accessStatusOptions, section: "Usuario" },
      { name: "max_admin_invitations", label: "Numero de convites", type: "number", optional: true, section: "Usuario" },
